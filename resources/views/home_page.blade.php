...
<style>
...
</head><body><nav class="navbar navbar-expand-lg navbar-light page-header" id="mainNav" style="background-color: transparent; padding-top:5px; padding-bottom:5px;">
  <div class="container-fluid">
    ...
    <a class="navbar-brand " href="{{url('home')}}" style="font-size: 1.8rem; font-weight: 700;"><i>เลือกได้เลือกดี</i></a>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body text-center">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:#fff; padding: 0px 0px 10px 10px;"><span aria-hidden="true">×</span> ปิด</button>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item action-nav">
          <a class="nav-link a-head   js-scroll-trigger hidden-sm hidden-xs" id="&quot;a-head-set&quot;" style="font-size: 16px; padding: 16px 25px 10px; " href="{{url('home')}}">เลือกอะไรได้?</a>

        </li>
        <li class="nav-item  " style="margin-right: 30px;">

          <a class="nav-link    js-scroll-trigger hidden-sm hidden-xs" style="font-size: 16px; padding: 16px 25px 10px; " href="{{url('representatives_all')}}">เลือกใครดี?</a>
