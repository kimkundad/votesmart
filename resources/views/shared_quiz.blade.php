...
<head>
  ...
  <meta property="og:url"           content="{{url('shared_quiz/'.$user->id)}}" />
  <meta property="og:type"          content="website" />
  <meta property="og:title"         content="ถ้าต้องบริหารประเทศไทย" />
  <meta property="og:image"         content="{{url('assets/image/shared/'.$user->image_shared.'?v='.$time_fb)}}" />
...
<body>
  ...
  <div class="col-md-8">
               ...
               <hr>
               <img src="{{url('image/shared/'.$user->image_shared.'?v='.$time_fb)}}" class="img-responsive">
